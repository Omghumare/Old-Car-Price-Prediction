...
year = st.slider('Car Manufractured Year', 1990, 2024, 2021)
km_driven = st.slider('Car Kms Driven', 0, 500000, 10000)
fuel = st.selectbox('Car Fuel Type', cars_data['fuel'].unique())
seller_type = st.selectbox('seller type', cars_data['seller_type'].unique())
transmission = st.selectbox('Transmission type', cars_data['transmission'].unique())
owner = st.selectbox('Owner', cars_data['owner'].unique())
mileage = st.slider('Car Mileage', 10, 60)
